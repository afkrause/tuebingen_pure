...
void PupilTrackingMethod::registerPupil( const int ts, Pupil &pupil )
{
...
void PupilTrackingMethod::run(const int ts, const cv::Mat &frame, const cv::Rect &roi, Pupil &pupil, PupilDetectionMethod &pupilDetectionMethod)
{
